...
const blogPosts = [
  {
    ...
    excerpt: 'As inscrições para o aguardado Campori de Desbravadores 2025 já estão abertas! Confira como participar e garantir a presença do seu clube.',
  ...
  {
    id: 2,
    title: 'Conheça as atividades previstas para o evento',
    excerpt: 'Exploramos em detalhes todas as atividades planejadas para o Campori 2025. Prepare-se para aventuras inesquecíveis que desafiarão corpo e mente.',
  ...
  },
  {
    ...
    excerpt: 'O tema escolhido para o Campori 2025 convida os desbravadores a viverem cada momento com propósito e significado, crescendo em todas as áreas da vida.',
